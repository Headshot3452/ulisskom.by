<?php
    ...
    $header .= '<a data-placement="bottom" title="Добавить новость" href="'.$this->createUrl('create_product').'?tree_id='.$category_id.'" class="btn btn-action"><span class="icon-admin-add-product"></span></a>';
    ...
    $this->widget('application.widgets.ProductListViewAdmin',
        array(
            ...
            'ajaxUpdate' => false,
            'emptyText' => 'Новости, акции или статьи - отсутствуют!',
