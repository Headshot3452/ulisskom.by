...
echo '<div class="tabs-blog">';
echo BsHtml::tabs(
    array(
        array(
            'label' => Yii::t('app', 'Posts'),
            'url' => $this->createUrl('blogclients/blog', array('id'=>$user_id)),
            'active' =>(Yii::app()->controller->action->id == 'blog')?true:false,
        ),
        array(
            'label'=> Yii::t('app', 'Comments'),
            'url' => $this->createUrl('blogclients/comments', array('id'=>$user_id)),
            'active' =>(Yii::app()->controller->action->id == 'comments')?true:false,
        ),
    )
);
echo '</div>';
