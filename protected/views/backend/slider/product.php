...
<?php
    ...
    $action = isset($_GET['tree_id']) ? 'Создание (Слайдера, баннера)' : 'Редактирование. #'.$model->id;
?>
...
<?php
        ...
        {
            echo '<a data-placement="bottom" data-hint="Удалить слайдер" href="'.$check['url'].'" class="btn btn-small btn-trash hint--bottom hint--rounded"><span class="fa fa-trash-o"></span></a>';
        }
