...
$src = '
        ...
        $(".one-news.last-news.col-md-4 .title").dotdotdot({
		    ellipsis	: "... ",
		    wrap		: "word",
...
foreach($this->_items as $item)
{
    ...
    echo '<div class="one-news last-news col-md-4">
                    ...
                    <h3 class="title">'.CHtml::link($item->title,array('news/item','name'=>$item->name)).'</h3>
           </div>';
}
