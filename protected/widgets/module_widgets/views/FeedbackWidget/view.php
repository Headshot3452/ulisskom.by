...
<div class="body">
   <span class="text-primary">
     Внимание! Прежде чем задать свой вопрос, внимательно прочтите ответы на частозадаваемые вопросы. Возможно, здесь уже есть информация интересующая Вас
   </span>
</div>
<div class="footer">
    <?php
    echo BsHtml::link('Задать вопрос', '#modal_new_feedback', array('class' => 'btn btn-primary', 'data-toggle' => 'modal'));
    ?>
</div>

<div class="modal fade" id="modal_new_feedback" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php $form=$this->beginWidget('BsActiveForm', array(
                ...
                'action'=>$this->controller->createUrl('askanswer/feedback'),
...
<?php
                ...
                if($this->settings['load_file_feedback']==1){
                    ...
                    <div class="form-group col-xs-12 upload-file feedback">
                        ...
                        $this->widget('application.extensions.EFineUploader.EFineUploader',
                            array(
                                ...
                                'config' => array(
                                    ...
                                    'autoUpload' => true,
                                    'request' => array(
                                        'endpoint' => $this->controller->createUrl('feedback/upload'),
        ...
        ");
            ...
            <div class="modal-footer">
                ...
                <?php echo BsHtml::ajaxSubmitButton(Yii::t('app','Отправить'), $this->controller->createUrl('askanswer/feedback'), array(
                        'dataType'=>'json',
                        'type'=>'POST',
                    ...
                    array('class'=>'btn btn-primary', 'id'=>'add_btn')); ?>
            </div>
