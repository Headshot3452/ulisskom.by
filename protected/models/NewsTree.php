 ...
 *
 * The followings are the available columns in table 'news_tree':
 * @property string $id
 ...
 */
class NewsTree extends Model
{
	const PathImage='data/news/tree/';
	...
	public function relations()
	{
		...
		return array(
			'news' => array(self::HAS_MANY, 'News', 'parent_id'),
            'item' => array(self::HAS_MANY, 'News', 'parent_id'),
